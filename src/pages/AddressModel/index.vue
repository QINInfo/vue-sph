    ...
    >
      ...
      <el-form>
        ...
        <el-form-item label="联系电话:" :label-width="formLabelWidth">
          <el-input autocomplete="off" v-model="addressInfo.phoneNum" class="input-item"></el-input>
        </el-form-item>

        <el-form-item label="所在地区:" :label-width="formLabelWidth">
          <!-- 华北,华中等 -->
          <el-select placeholder="请选择所在区域" v-model="addressInfo.regionId">
            <el-option
...
export default {
  ...
  watch: {
    ...
    changAddressInfo: {
      handler() {
        let { consignee, phoneNum, isDefault, regionId, provinceId, userAddress } =
